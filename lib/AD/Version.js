...
AD.Version.prototype.constructor = AD.Version;

AD.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
AD.Version.prototype.getVersionHash = function(callback) {
...
AD.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
