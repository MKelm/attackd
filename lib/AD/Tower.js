...
AD.Tower = function(game, position) {
  ...
  this.bulletTiming = { delay: 1000, lastShoot: -1 }; // delay between bullets
...
AD.Tower.prototype.addBullet = function(enemy, fps) {
  ...
  var shootTime = ad.util.time(), shootTimeDiff = shootTime - this.bulletTiming.lastShoot;
  if (this.bullets.length < this.maxBullets &&
      (this.bulletTiming.lastShoot == -1 || shootTimeDiff > this.bulletTiming.delay)) {
