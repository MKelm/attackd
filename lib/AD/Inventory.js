...
AD.Inventory = function() {
  ...
  this.towers = [
    { title: "Canon Tower", costs: 500, available: false, gfx: null },
    { title: "Gun Tower", costs: 1000, available: false, gfx: null },
    { title: "Laser Tower", costs: 1800, available: false, gfx: null },
    { title: "Quake Tower", costs: 2500, available: false, gfx: null }
  ];
}
...
AD.Inventory.prototype.towerClick = function(towerType) {
  // handle tower click event
  if (this.towers[towerType].available == true) {
    console.log("invTClick.valid");
  } else {
    console.log("invTClick.invalid");
  }
}