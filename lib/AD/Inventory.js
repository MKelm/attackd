...
AD.Inventory = function() {
  ...
  this.towers = [
    { title: "Canon Tower", costs: 500, available: false, gfx: null, selected: false },
    { title: "Gun Tower", costs: 1000, available: false, gfx: null, selected: false },
    { title: "Laser Tower", costs: 1800, available: false, gfx: null, selected: false },
    { title: "Quake Tower", costs: 2500, available: false, gfx: null, selected: false }
  ];
}
...
AD.Inventory.prototype.towerClick = function(towerId) {
  ...
  if (this.towers[towerId].available == true) {
    for (var i = 0; i < this.towers.length; i++) {
      this.towers[i].selected = (i == towerId) ? true : false;
    }
  }
}