...
AD.Inventory.prototype.addHeadMoney = function() {
  // add head money on enemy destroyed
  this.money += 100;
  this.update();
}

AD.Inventory.prototype.payTower = function() {
  this.money -= this.towers[this.selectedTowerId].costs;
  this.update();
}
...
AD.Inventory.prototype.update = function(display) {
  ...
  for (var i = 0; i < this.towers.length; i++) {
    ...
    if (this.towers[i].costs > this.money) {
      ...
      if (this.selectedTowerId == i) this.selectedTowerId = -1;
