...
AD.Map.prototype.fieldClick = function(display, inventory, fieldType, fieldCoor) {
  if (fieldType == 0 && inventory.selectedTowerId > -1) {
    display.drawTower(inventory.selectedTowerId, fieldCoor.x - 50, fieldCoor.y - 50);
    console.log("field click x "+ fieldCoor.x +", y "+fieldCoor.y);
  }
}