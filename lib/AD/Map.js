...
AD.Map.prototype.fieldClick = function(display, inventory, fieldType, fieldPosition, fieldCoor) {
  if (fieldType == 0 && inventory.selectedTowerId > -1) {
    // todo add tower handler to manage towers!
    var tower = new AD.Tower(fieldType);
    tower.gfx = display.drawTower(inventory.selectedTowerId, fieldCoor.x + 1, fieldCoor.y + 1);
    console.log("field click x "+ fieldPosition.x +", y "+fieldPosition.y);
  }
}