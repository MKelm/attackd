...
AD.Enemy.prototype.move = function(path, fps) {
  ...
  var spriteCoor = { x: this.sprite.position.x, y: this.sprite.position.y };
  ...
  switch (this.position.direction) {
    case 2: // down
      if (spriteCoor.y < this.position.coor.y + distance) {
      ...
      break;
    case 4: // left
      if (spriteCoor.x > this.position.coor.x - distance) {
