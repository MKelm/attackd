...
AD.Enemy.prototype.setPositionSettings = function(map) {
  // settings depends on current (field) position
  this.position.direction = map.getFieldType(this.position.x, this.position.y);
  // detect correct source enemy / target field coor
  this.position.coor = map.getFieldCoor(this.position.x, this.position.y);
}
