...
AD.Display.prototype.drawInventarArea = function() {
  ...
  // draw inventar items
  this.drawCanonTower(35, 30, true, invGfx);
  this.drawGunTower(35, 160, true, invGfx);
  this.drawLaserTower(35, 290, true, invGfx);
  this.drawQuakeTower(35, 420, true, invGfx);
...
AD.Display.prototype.drawGunTower = function(x, y, title, targetGfx) {
  var tWidth = 100, tHeigth = 100;
  var tGfx = new PIXI.DisplayObjectContainer();
  tGfx.position = { x: x || 0, y: y || 0 };
  ...
  if (title == true) {
    var style = {font: Math.floor(38 * ad.pixi.screen.ratio) + "px " + "Arial", fill: "4C4C4C"};
    var tTitle = new PIXI.Text("Gun Tower", style);
    tTitle.anchor = { x: 0.5, y: 0.5 };
    tTitle.position = { x: tWidth / 2, y: tHeigth + 10 };
    tGfx.addChild(tTitle);
  }
...
AD.Display.prototype.drawLaserTower = function(x, y, title, targetGfx) {
  var tWidth = 100, tHeigth = 100;
  var tGfx = new PIXI.DisplayObjectContainer();
  tGfx.position = { x: x || 0, y: y || 0 };
  ...
  if (title == true) {
    var style = {font: Math.floor(38 * ad.pixi.screen.ratio) + "px " + "Arial", fill: "4C4C4C"};
    var tTitle = new PIXI.Text("Laser Tower", style);
    tTitle.anchor = { x: 0.5, y: 0.5 };
    tTitle.position = { x: tWidth / 2, y: tHeigth + 10 };
    tGfx.addChild(tTitle);
  }
...
AD.Display.prototype.drawQuakeTower = function(x, y, title, targetGfx) {
  var tWidth = 100, tHeigth = 100;
  var tGfx = new PIXI.DisplayObjectContainer();
  tGfx.position = { x: x || 0, y: y || 0 };
  ...
  if (title == true) {
    var style = {font: Math.floor(38 * ad.pixi.screen.ratio) + "px " + "Arial", fill: "4C4C4C"};
    var tTitle = new PIXI.Text("Quake Tower", style);
    tTitle.anchor = { x: 0.5, y: 0.5 };
    tTitle.position = { x: tWidth / 2, y: tHeigth + 10 };
    tGfx.addChild(tTitle);
  }
