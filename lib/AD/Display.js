...
AD.Display.prototype.initialize = function() {
  ...
  var scope = this;
  ad.pixi.resizeCallback = function() { scope.handleResize(); };
}

AD.Display.prototype.handleResize = function() {
...
AD.Display.prototype.remove = function() {
  ad.pixi.stage.removeChild(this.container);
}
...
AD.Display.prototype.drawEnemies = function(enemyHandler) {
  ...
  for (var i = 0; i < enemyHandler.enemies.length; i++) {
    enemyHandler.enemies[i].sprite = this.drawEnemy(startCoor.x, startCoor.y);
  }
}
