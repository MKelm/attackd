...
AD.Display.prototype.drawInventoryArea = function(inventory) {
  ...
  for (var i = 0; i < inventory.towers.length; i++) {
    this.drawTower(i, invTowerPos[i].x, invTowerPos[i].y, inventory.towers[i], invGfx);
  }
...
AD.Display.prototype.drawTower = function (type, x, y, data, targetGfx) {
