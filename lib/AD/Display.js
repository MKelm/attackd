...
AD.Display.prototype.drawCanonTower = function(tGfx) {
  var texture = PIXI.Texture.fromImage("data/gfx/tower_canon.png");
  var sprite = new PIXI.Sprite(texture);
...
AD.Display.prototype.drawGunTower = function(tGfx) {
  var texture = PIXI.Texture.fromImage("data/gfx/tower_gun.png");
  var sprite = new PIXI.Sprite(texture);
  sprite.position = { x: -2, y: -2 };
  tGfx.addChild(sprite);
}
...
AD.Display.prototype.drawLaserTower = function(tGfx) {
  var texture = PIXI.Texture.fromImage("data/gfx/tower_laser.png");
  var sprite = new PIXI.Sprite(texture);
  sprite.position = { x: -2, y: -2 };
  tGfx.addChild(sprite);
}
...
AD.Display.prototype.drawEnemy = function(x, y) {
  var texture = PIXI.Texture.fromFrame("data/gfx/fooshl.png");
  var sprite = new PIXI.Sprite(texture);
