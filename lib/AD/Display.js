...
AD.Display.prototype.drawTower = function (type, x, y, inventoryData, targetGfx) {
  ...
  // click event sprite depends on tower position (inventory or field)
  ...
  var callback = function(mouse) {
    ...
    if (typeof inventoryData != "undefined") {
      ...
      // todo: set tower field position to eventContent!
      ad.game.dispatchEvent({ type: "field-tower-clock", content: eventContent });
    }
  };
